/* 
   Скрипт запускаетя на Standby Database. 
   Если значения LowGap# и HighGap# различны, 
   то необходимо вручную применить архивированный журнал 
   с номерами от LowGap# до HighGap# 
*/
